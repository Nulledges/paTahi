...
const StoreCollectedOrdersScreen = props => {
  ...
  useFocusEffect(
    useCallback(() => {
      dispatch(orderActions.fetchStoreOnGoingOrders(storeInformation.storeId));
    }, []),
  );
      ...
      <View>
          ...
          onPress={() => {
            {
              item.orderType == 'premade'
                ? props.navigation.navigate('STORE ORDERS DETAILS PREMADE', {
                    orderItems: item,
                  })
                : props.navigation.navigate('STORE ORDERS DETAILS', {
                    orderItems: item,
                  });
            }
          }}>
        ...
        <View style={styles.finishedContainer}>
          <MainButton
            ...
            onPress={() => {
              dispatch(orderActions.updateOngoingOrder(item.id, item.userId));
            }}
          />
        </View>
      </View>
  ...
  console.log(storeOngoingOrders);
  return (
