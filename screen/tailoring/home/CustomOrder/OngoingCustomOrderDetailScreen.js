...
const OngoingCustomOrderDetailScreen = props => {
  const dispatch = useDispatch();
  const orders = props.route.params.orderItems;

  const toPickupHandler = async () => {
    dispatch(
      orderActions.updateOngoingRequest(
        orders.id,
        orders.balance,
        orders.userId,
      ),
...
export default OngoingCustomOrderDetailScreen;
