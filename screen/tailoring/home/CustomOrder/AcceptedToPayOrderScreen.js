...
const AcceptedToPayOrderScreen = props => {
  ...
  useEffect(() => {
    dispatch(orderActions.fetchAcceptedOrder(storeInformation.storeId));
    console.log('AcceptedToPayOrderScreen');
  }, []);
    ...
    return (
      <View>
        <View
          ...
          {/* item.isStoreSeen != false ? (
            <Text style={styles.notificationIndicatorUnseen2}>Seen</Text>
          ) : (
            <Text style={styles.notificationIndicatorUnseen2}>Unseen</Text>
          ) */}
          <Text
            style={[
              styles.textStyle,
          ...
          <View>
            <MainButton
              ...
              onPress={() => {
                dispatch(orderActions.updateStoreAcceptedSeen(item.id));
                props.navigation.navigate(
                  'STORE ACCEPTED CUSTOM ORDER DETAIL',
                  {
                    orderItems: item,
                  },
                );
...
export default AcceptedToPayOrderScreen;
