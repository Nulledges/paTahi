...
const OngoingCustomOrderScreen = props => {
  ...
  useEffect(() => {
    dispatch(orderActions.fetchOngoingOrder(storeInformation.storeId));
    console.log('OngoingCustomOrderScreen');
  }, []);
        ...
        <View
          ...
          <View>
            <MainButton
              ...
              onPress={() => {
                dispatch(orderActions.updateStoreOngoingSeen(item.id));
                props.navigation.navigate('STORE ONGOING CUSTOM ORDER DETAIL', {
                  orderItems: item,
                });
              }}
            />
...
export default OngoingCustomOrderScreen;
