...
const PendingCustomOrderScreen = props => {
  ...
  useEffect(() => {
    dispatch(orderActions.fetchPendingOrder(storeInformation.storeId));
    console.log('PendingCustomOrderScreen');
  }, []);
        ...
        <View
          ...
          <View>
            <MainButton
              ...
              onPress={() => {
                dispatch(orderActions.updateStorePendingSeen(item.id));
                props.navigation.navigate('STORE PENDING CUSTOM ORDER DETAIL', {
                  orderItems: item,
                });
              }}
            />
...
export default PendingCustomOrderScreen;
