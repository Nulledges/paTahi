...
const UserCancelledCustomOrderScreen = props => {
  ...
  useEffect(() => {
    dispatch(orderActions.fetchUserCancelledOrder);
    console.log('UserCancelledCustomOrderScreen');
  }, []);
        ...
        <View
          ...
          <View>
            <MainButton
              ...
              onPress={() => {
                dispatch(orderActions.updateUserCancelledSeen(item.id));
                props.navigation.navigate(
                  'USER CANCELLED CUSTOM ORDERS DETAIL',
                  {
                    orderItems: item,
                  },
                );
...
export default UserCancelledCustomOrderScreen;
