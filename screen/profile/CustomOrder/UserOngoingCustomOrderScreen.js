...
const UserOngoingCustomOrderScreen = props => {
  ...
  useEffect(() => {
    dispatch(orderActions.fetchUserOngoingOrder);
    console.log('UserOngoingCustomOrderScreen');
  }, []);
        ...
        <View
          ...
          <View>
            <MainButton
              ...
              onPress={() => {
                dispatch(orderActions.updateUserOngoingSeen(item.id));
                props.navigation.navigate('USER ONGOING CUSTOM ORDERS DETAIL', {
                  orderItems: item,
                });
              }}
            />
...
export default UserOngoingCustomOrderScreen;
