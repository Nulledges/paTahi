...
const UserCancelledCustomOrderDetailScreen = props => {
  ...
  useEffect(() => {
    if (paymentDetails.length == undefined) {
      ...
      dispatch(
        orderActions.updateTopickupBalance(orders.id, balance, orders.storeId),
      );
...
export default UserCancelledCustomOrderDetailScreen;
