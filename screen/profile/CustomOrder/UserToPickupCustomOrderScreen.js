...
const UserToPickupCustomOrderScreen = props => {
  ...
  useEffect(() => {
    dispatch(orderActions.fetchUserToPickupOrder);
    console.log('UserToPickupCustomOrderScreen');
  }, []);
        ...
        <View
          ...
          <View>
            <MainButton
              ...
              onPress={() => {
                dispatch(orderActions.updateUserToPickupSeen(item.id));
                props.navigation.navigate(
                  'USER TOPICKUP CUSTOM ORDERS DETAIL',
                  {
                    orderItems: item,
                  },
                );
...
export default UserToPickupCustomOrderScreen;
