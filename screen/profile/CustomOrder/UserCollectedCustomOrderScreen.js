...
const UserCollectedCustomOrderScreen = props => {
  ...
  useEffect(() => {
    dispatch(orderActions.fetchUserCollectedOrder);
    console.log('UserCollectedCustomOrderScreen');
  }, []);
        ...
        <View
          ...
          <View>
            <MainButton
              ...
              onPress={() => {
                dispatch(orderActions.updateUserCollectedSeen(item.id));
                props.navigation.navigate(
                  'USER COLLECTED CUSTOM ORDERS DETAIL',
                  {
                    orderItems: item,
                  },
                );
...
export default UserCollectedCustomOrderScreen;
