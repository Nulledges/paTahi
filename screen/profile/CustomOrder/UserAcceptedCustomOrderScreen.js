...
const UserAcceptedCustomOrderScreen = props => {
  ...
  useEffect(() => {
    dispatch(orderActions.fetchUserAcceptedOrder);
    console.log('UserAcceptedCustomOrderScreen');
  }, []);
    ...
    return (
      <View>
        <View
          ...
          <Text style={styles.notificationIndicatorUnseen2}>To pay</Text>
          ...
          <View>
            <MainButton
              ...
              onPress={() => {
                dispatch(orderActions.updateUserAcceptedSeen(item.id));
                props.navigation.navigate(
                  'USER ACCEPTED CUSTOM ORDERS DETAIL',
                  {
                    orderItems: item,
                  },
                );
...
export default UserAcceptedCustomOrderScreen;
